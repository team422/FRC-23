...
public final class Constants {
  ...
  public static final class ElevatorConstants {
    ...
    public static final double kElevatorMassKG = 4;
    ...
    public static final double kZeroAmperageThreshold = 10.0;
    public static final int kZeroAmperageCountThreshold = 10;
    public static final double kZeroAmperageTimeThreshold = 1.0;

    public static final double kElevatorTestHeights[] = { Units.inchesToMeters(20), Units.inchesToMeters(25),
        Units.inchesToMeters(30),
        Units.inchesToMeters(40), Units.inchesToMeters(50) };
  }
