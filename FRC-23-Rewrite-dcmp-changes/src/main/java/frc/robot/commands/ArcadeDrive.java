...
public class ArcadeDrive extends CommandBase {
    ...
    private EricNubControls erics = new EricNubControls();
    /**
    ...
    public void execute() {
        ...
        leftXValue = erics.addDeadzoneScaled(leftXValue, 0.1);
        double leftYValue = leftYSupplier.get();
        leftYValue = erics.addDeadzoneScaled(leftYValue, 0.1);
        ...
        // GET RID OF THE THe THING BELOW:
        // forwardSpeed /= 4;
